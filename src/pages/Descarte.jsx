...
import { Layout, Col, Row, Button, Card, Divider, Tooltip, Radio, Modal, Form } from 'antd';
      ...
      <Col offset={3} span={18} style={{ flex: '1', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <Row>
          ...
          <Form form={form} onFinish={(values) => send('NEXT', { data: values })}>
            <Form.Item>
              <Button htmlType="submit" danger type='primary' size='large' style={{ borderRadius: '5px', height: '50px', width: '150px', fontWeight: 'bold' }}>
                Siguiente
              </Button>
            </Form.Item>
          </Form>
